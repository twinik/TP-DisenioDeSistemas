...
public class PuntosAltaPersonaVulnerableTest {
    ...
    FormaColaboracion persona = new FormaColaboracion(2,"REGISTRO_PERSONA");
    ...
    void test_init(){
        ...
        donacion_1 = new AltaPersonaVulnerable(colaborador, personaVulnerable_1, tarjeta_1, LocalDate.of(2023, 1, 1), (CalculadorPuntosAltaPersona) CalculadorDePuntosFactory.create(persona));
        donacion_2 = new AltaPersonaVulnerable(colaborador, personaVulnerable_2, tarjeta_2, LocalDate.of(2024, 4, 5),(CalculadorPuntosAltaPersona) CalculadorDePuntosFactory.create(persona));
    }
