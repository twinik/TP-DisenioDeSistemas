...
public class Initializer {
  ...
  public static void init() {
    ...
    Colaborador c1 = new Colaborador(u1, TipoDocumento.DNI, "4432653", tipo, 200f, null, new Direccion("medrano", 951, 3, "1405"), listaContacto, "jorge", "lopez", LocalDate.of(1999, 10, 10), null, null, null, true);
